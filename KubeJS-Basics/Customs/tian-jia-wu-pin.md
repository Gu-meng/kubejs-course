...
| :-----------------: | :------: | :------------------: | :-----------------------------------: |
|       `basic`       | 基础物品 |          无          |                   -                   |
|       `basic`       | 基础物品 |          -           |    [添加食物](./item-type/food.md)    |
...
|     `leggings`      |   护腿   |          无          |                 同上                  |
|       `boots`       |   鞋子   |          无          |                 同上                  |
|        `axe`        |   斧子   |          无          |             [添加工具](./item-type/tools.md)              |
|        `hoe`        |   锄头   |          无          |                 同上                  |
|      `pickaxe`      |   镐子   |          无          |                 同上                  |
|      `shovel`       |   铲子   |          无          |                 同上                  |
|       `sword`       |    剑    |          无          |                 同上                  |
...
|                   food(Consumer\<FoodBuilder>)                    |    ->    |   [设置物品为食物](./item-type/food.md)   |   this   |
...
|                    rarity(Rarity)                     | [稀有度](/ti-wai-hua/xi-you-du.md) |   设置物品稀有度   |      this       |
